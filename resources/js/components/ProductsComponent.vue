				...
				<div class="col-lg-3 order-2 order-lg-1">
					<div class="filter-widget">
						...
						<ul class="category-menu">
							<li v-for="category in categories" v-bind:key="category.id"><a href="#">{{category.name}}</a>
							</li>
						</ul>
					</div>
						...
						<div class="col-lg-4 col-sm-6" v-for="product in products" :key="product.id">
							<div class="product-item">
								<div class="pi-pic">
									...
									<div class="pi-links">
										<router-link :to="`/product/${product.id}`" class="add-card"><i class="flaticon-bag"></i><span>Voir Plus</span></router-link>
...
export default {
  ...
  methods:{
    listProducts(){ 
     axios.get('user/products').then(res=> this.products=res.data)
    },
     listCategories(){
    axios.get('user/categories').then(res=>this.categories=res.data)
    },
